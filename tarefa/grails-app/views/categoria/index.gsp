...
<html lang="en">
    ...
    <body>
      ...
      <section>
        <nav>
        <g:remoteLink controller="categoria" action="adicionar" update="formCategorias">Adicionar Categoria</g:remoteLink>
        &nbsp;&nbsp;
        <g:link controller="tarefa" action="index">Adicionar Tarefa</g:link>
      </nav>
      </section>
